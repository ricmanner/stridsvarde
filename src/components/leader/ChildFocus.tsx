  ...
  return (
    <div>
      ...
      <div className="mb-3 flex flex-wrap items-center gap-2">
        <span className="text-[12px] text-slate-500">Visa {ental}:</span>
        {synliga.map((c) => (
          <button
            key={c.id}
            type="button"
            ...
            className={`cursor-pointer rounded-md border-[1.5px] px-3 py-1.5 text-[13px] font-semibold transition-colors ${
              c.id === vald.id
      ...
      <div className="grid items-start gap-3 lg:grid-cols-2">
        <div className="rounded-md border border-slate-200 bg-white px-3 pb-3 pt-3">
          <div className="mb-2 flex flex-wrap items-center justify-between gap-2 px-1">
            <span className="text-[13px] font-semibold text-slate-800">Över tid</span>
            {nyckel}
          </div>
        ...
        <div className="rounded-md border border-slate-200 bg-white px-3 pb-3 pt-3">
          <div className="mb-2 flex flex-wrap items-center justify-between gap-2 px-1">
            <span className="text-[13px] font-semibold text-slate-800">Profil</span>
            {nyckel}
          </div>
            ...
            {CATEGORIES.map((c) => {
              ...
              return (
                <button
                  ...
                  onClick={() => vaxla(c.key)}
                  aria-pressed={pa}
                  className={`flex cursor-pointer items-center gap-1 rounded border-[1.5px] px-2 py-1 text-[11px] font-semibold transition-colors ${
