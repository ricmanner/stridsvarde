...
/**
 * Behörigheten kontrolleras på servern i page.tsx innan den här komponenten
 * renderas — inte längre med en useEffect-redirect som vem som helst kunde
 * kringgå genom att stänga av JavaScript.
 */
export default function PlutonDashboard({ unit }: { unit: string }) {
